...
* OJ (<https://twitter.com/TheColonial>) and Pipes (<https://twitter.com/dotslashpipe>) for QA
* timkent, jburger, xens, and lesydimitri for various fixes
...
exploit that throws plain old 8-bit bytes and ASCII characrers around, it can
...
any functional bugs or securitry vulnerabilities.
